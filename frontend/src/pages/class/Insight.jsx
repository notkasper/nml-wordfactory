  ...
  return (
		<div>
			<Grid container spacing={3} className={classes.widget}>
				<PaperWithHeader headercolor={theme.widget.primary.main} headertitle="Leerlingen die aandacht nodig hebben">
					<DataGrid
						autoHeight
						rows={[
				...
				<PaperWithHeader headercolor={theme.widget.primary.main} headertitle="Top 3 leerlingen">
					<DataGrid
						autoHeight
						rows={[
